...
def main() -> None:
    ...
    if page == "Overview":
        render_overview(repository, selected_id, selected_periods, as_of)
    elif page == "Select":
        ...
        _render_monitor(repository, selected_id, as_of)
    elif page == "Update":
...
def _render_monitor(repository, decision_id: str, as_of: date) -> None:
